            ...
            <div className="ml-20 flex flex-col justify-center items-center p-8 w-full h-screen">
                <div className="mr-auto place-self-center">
                    ...
                    <div className="relative px-4">
                        <textarea onChange={(e) => {setUserQuery(e.target.value)}} rows="6" className="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500" placeholder="Example: Buy 5 PS5">
                        </textarea>
